        ...
        <div className="row">
        	<div className="col-md-4">
        		<div className="property-wrap ftco-animate">
        			<a href="#" className="img" style="background-image: url(images/work-1.jpg);"></a>
        			<div className="text">
        	...
        	<div className="col-md-4">
        		<div className="property-wrap ftco-animate">
        			<a href="#" className="img" style="background-image: url(images/work-2.jpg);"></a>
        			<div className="text">
        				<p className="price"><span className="old-price">800,000</span><span className="orig-price">$3,050<small>/mo</small></span></p>
        				<ul className="property_list">
        					<li><span className="flaticon-bed"></span>3</li>
        	...
        	<div className="col-md-4">
        		<div className="property-wrap ftco-animate">
        			<a href="#" className="img" style="background-image: url(images/work-3.jpg);"></a>
        			<div className="text">
        				<p className="price"><span className="old-price">800,000</span><span className="orig-price">$3,050<small>/mo</small></span></p>
        				<ul className="property_list">
        					<li><span className="flaticon-bed"></span>3</li>
